/* eslint-disable eslint-comments/disable-enable-pair -- test */
/* eslint-disable internal-rules/multiline-comment-style -- test */
...
/**
 * Group the errors and count
 * @param {Object} messages error messages reported by eslint
...
function verifyText({
    ...
    const errors = groupErrors(messages);
